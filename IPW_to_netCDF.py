...
# Note: adapted from Micah Johnson script which was adapted from Basin_Sequp

def write_nc(fp_out, var_data, ts, var_list):
    s = nc.Dataset(fp_out, 'w',
    ...
    for idx, vr in enumerate(var_list):
